...
Вы не можете присвоить суммарно vCPU больше чем есть реально в системе (берём потоки hyper threading тоже). Но возможно есть сценарии, тогда зааффектит perfomance. <br>
